...
const p_queue_1 = __importDefault(__nccwpck_require__(1557)); // tslint:disable-line:import-name
const p_retry_1 = __importStar(__nccwpck_require__(5282));
const axios_1 = __importDefault(__nccwpck_require__(8228));
const form_data_1 = __importDefault(__nccwpck_require__(4275)); // tslint:disable-line:import-name
const methods = __importStar(__nccwpck_require__(2844)); // tslint:disable-line:import-name
...
__export(__nccwpck_require__(2844));
//# sourceMappingURL=index.js.map
...
var populate = __nccwpck_require__(6491);
...
var bind = __nccwpck_require__(9160);
var isBuffer = __nccwpck_require__(1265);
...
var debug = __nccwpck_require__(9938)("follow-redirects");
...
exports = module.exports = __nccwpck_require__(6956);
exports.log = log;
...
exports.humanize = __nccwpck_require__(8811);
...
if (typeof process === 'undefined' || process.type === 'renderer') {
  module.exports = __nccwpck_require__(7273);
} else {
  module.exports = __nccwpck_require__(3946);
}
...
try {
  var supportsColor = __nccwpck_require__(8812);
...
methodFn(args).then(
  result => core.setOutput("result", result),
  error => {
...
/******/ 	return __nccwpck_require__(8621);
/******/ })()
;